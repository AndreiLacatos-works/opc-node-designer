...
class AddContainerModal extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _AddContainerModal();
}

class _AddContainerModal extends State {
  final _formKey = GlobalKey<FormState>();
  final _labelController = TextEditingController();

  void _handleAdd(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      final node = OpcContainerNodeModel(
        id: Uuid().v4(),
